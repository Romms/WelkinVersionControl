...
$currentVersion = (Get-Item "The Welkin Suite\TheWelkinSuite.exe").VersionInfo.ProductVersion
...
if (!$copyExists) {
	...
	Copy-Item "The Welkin Suite\*" "The Welkin Suite $currentVersion"
	...
	$Shortcut.TargetPath = "$pwd\$copyName\TheWelkinSuite.exe"
	$Shortcut.Save()
}